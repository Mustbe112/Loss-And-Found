              ...
              <div key={claim.id} style={cardStyle}>
                ...
                <div style={actionsStyle}>
                  ...
                  {user?.id === claim.claimant_id && claim.status === 'verifying' && (
                    <button onClick={() => updateStatus(claim.id, 'confirmed')} style={btnConfirm}>
                      ✅ I Got My Item Back
                    </button>
                  )}
...
function StatusBadge({ status }) {
  const colors = {
    pending: '#ff9800', verifying: '#2196f3',
    confirmed: '#4caf50', rejected: '#e94560', disputed: '#f44336',
  };
  return (
    <span style={{
...
const btnConfirm = { background: '#4caf5020', color: '#4caf50', border: '1px solid #4caf50', padding: '0.4rem 1rem', borderRadius: '6px', fontSize: '0.85rem' };
const btnReject = { background: '#e9456020', color: '#e94560', border: '1px solid #e94560', padding: '0.4rem 1rem', borderRadius: '6px', fontSize: '0.85rem' };
