    ...
    <ProtectedRoute>
      ...
      <div style={pageStyle}>
        <div style={headerStyle}>
          <div>
            <h1 style={titleStyle}>📦 My Lost Items</h1>
            <p style={subtitleStyle}>Items you have reported as lost</p>
          </div>
          <Link href="/items/lost/new" style={btnPrimary}>+ Report New</Link>
        </div>
